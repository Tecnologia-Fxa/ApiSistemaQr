...
const ErrSendSms = async(req,res)=>{
    ...
    let { telefono_contacto } = req.body
    
    if(Array.isArray(telefono_contacto)){
        telefono_contacto.forEach(async(element) => {
            ...
            const usuario = await UsuarioModel.findOne({
                ...
                where:{telefono_contacto:element},
            ...
            if(usuario){
                ...
                try {
                    ...
                    if(usuario.codigo_descuento){
                        ...
                        if(!usuario.codigo_descuento.estado){
                            ...
                            const responseSms = await sendSMSCode( usuario.telefono_contacto, usuario.codigo_descuento.desc_codigo, usuario.nombres)
                    ...
                    //Pero si el usuario no tiene ningun codigo de descuento asignado va a ejecutar el siguiente fragmento de codigo
                        ...
                        const responseSms = await sendSMSCode( usuario.telefono_contacto, codigoDescuentoCreado.desc_codigo, usuarioCreado.nombres)
                ...
                console.log("Es necesario un registro previo para reenviar el mensaje")
