/* Mapeo de la tabla que va a almacenar las plantillas para generar campañas */
...
PlantillaModel.init({
    ...
    //campo que almacenara el titulo de la plantilla
    titulo:{
        //Tipo de dato texto con un tamaño maximo de 35 caracteres
        type:DataTypes.STRING(35),
        //Campo obligatorio
        allowNull:false,
    },

    //campo que almacenara el contenido del mensaje de la campaña.
    contenido:{
        //Tipo de dato String con un tamañomaximo de 350 caracteres
        type:DataTypes.STRING(350),
        //Campo obligatorio
        allowNull:false
    },

    //campo que almacenara la ruta en la cual se encuentra almacenada la imagen
    url_imagen:{
        //Tipo de dato string con tamaño maximo de 100 caracteres
