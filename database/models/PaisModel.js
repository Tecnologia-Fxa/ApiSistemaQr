/* Mapeo de la tabla que va a almacenar los paises para relaciónar a los estados y números de telefono del sistema*/
...
PaisModel.init({
    ...
    //Campo que almacena el codigo unico del pais
    codigo_pais:{
        //Tipo de dato texto con un maximo de 3 caracteres
    ...
    //campo que almacenara el nombre del respectivo pais
    nombre_pais:{
        //Tipo de dato string con un maximo de caracteres de 100
    ...
    //campo que almacenara el codigo de telefono de cada registro de pais
    codigo_telefonico:{
