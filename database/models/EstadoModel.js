/* Mapeo de la tabla que va a almacenar los estados para relaciónar a las ciudades del sistema*/
...
EstadoModel.init({
    ...
    //campo que almacenara el nombre del respectivo estado
    nombre_estado:{
    ...
    //Campo que almacenara el pais al que esta vinculado el registro del estado
    pais_fk:{
