...
const sendSMSCode = async (numeroTelefono, codigoDescuento, nombre) => {
    ...
    const params = {
        ...
        Message: `${nombre} gracias por el registro en tu tienda favorita FXA by fuxia, ¡Anímate a sacarle el máximo provecho! Tu código de descuento es: ${codigoDescuento}`,
